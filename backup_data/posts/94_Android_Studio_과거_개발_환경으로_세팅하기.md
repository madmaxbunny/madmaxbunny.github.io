...
date: "2020-11-23T02:00:45+09:00"
category: "프로그래밍/Android"
tags: ["Android Studio", "Gradle", "과거 버전 사용", "빌드 세팅"]
original_url: "https://priv.tistory.com/94"
tistory_id: 94
---
...
![](../images/img_94_01.png)Android Studio - Create New Project
...
![](../images/img_94_02.png)Android Studio - Project Structure
...
![](../images/img_94_03.png)build.gradle ![](../images/img_94_04.png)gradle-wrapper.properties

원하는 compileSdkVersion, minSdkVersion, targetSdkVersion, buildToolsVersion으로 바꾸어준다.

![](../images/img_94_05.png)
...
![](../images/img_94_06.png)

대부분 자동으로 바뀌었지만, 수기로 바꿔줘야 하는 부분도 있다.

1) activity_main.xml는 기본으로 세팅되는 태그가 <androidx.~ 로 시작한다. 예전 방식의 레이아웃으로 바꿔준다. 

![](../images/img_94_07.png)(수정전) activity_main.xml ![](../images/img_94_08.png)(수정후) activity_main.xml
...
![](../images/img_94_10.png)themes.xml

AndroidManifest.xml 파일도 수정해준다.

![](../images/img_94_11.png)(수정전) AndroidManifest.xml

![](../images/img_94_12.png)(수정후) AndroidManifest.xml

androidx 관련 라이브러리를 삭제하고, android.support 라이브러리를 추가한다.

![](../images/img_94_13.png)(수정전) MainActivity.java ![](../images/img_94_14.png)(수정후) MainActivity.java
