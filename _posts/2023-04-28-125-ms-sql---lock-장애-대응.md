...
> **[핵심 요약]**
> MS SQL Server에서 데이터베이스 LOCK(블로킹) 장애 발생 시 sp_who2 및 계층 쿼리로 원인 프로세스를 추적하고 해제하는 방법에 대한 노트이에요.

---

## 1. 개요 및 배경

MS SQL 운영 중 특정 트랜잭션이 테이블 락을 잡고 있어 서비스 응답이 정체되었을 때 빠르게 원인을 찾아 조치한 경험을 정돈해봤어요.
