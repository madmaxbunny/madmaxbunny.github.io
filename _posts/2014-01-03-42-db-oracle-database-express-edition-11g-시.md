...
> **[핵심 요약]**
> [DB] Oracle Database Express Edition 11g 시작하기 작업에 대해 실무에서 검증된 핵심 설정 및 처리 방법을 정돈해둔 노트이에요.

---

## 1. 개요 및 배경

[DB] Oracle Database Express Edition 11g 시작하기에 관해 개발 및 인프라 운용 과정에서 접했던 내용들을 공유해볼게요.
