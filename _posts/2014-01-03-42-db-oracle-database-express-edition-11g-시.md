...
> **[핵심 요약]**
> [DB] Oracle Database Express Edition 11g 시작하기 작업 시 검증했던 핵심 내용과 설정 가이드를 정리해둔 노트이에요.

---

## 1. 개요 및 배경

[DB] Oracle Database Express Edition 11g 시작하기과 관련해 개발 및 인프라 운용 과정에서 알게 된 점들을 공유해요.
