...
---
> **[핵심 요약]**
> React Native 앱의 수동 스토어 업데이트 없이 자바스크립트 커밋을 즉시 배포하는 CodePush Android 적용법입니다.

---

## 1. 개요 및 배경

[ReactNative] code push - Android은 컴퓨터 프로그래밍 및 시스템 운용 시 자주 접하게 되는 핵심 기술 요소입니다. 

---

## 2. 핵심 설명 및 코드

> [ReactNative] code push - Android의 기본 개념과 실무 적용 명령어를 
