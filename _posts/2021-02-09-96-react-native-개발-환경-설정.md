...
---
> **[핵심 요약]**
> React Native 개발을 위한 Node.js, Watchman, Android SDK 환경 변수 설정 절차입니다.

---

## 1. 개요 및 배경

React-native 개발 환경 설정은 컴퓨터 프로그래밍 및 시스템 운용 시 자주 접하게 되는 핵심 기술 요소입니다. 

---

## 2. 핵심 설명 및 코드

> React-native 개발 환경 설정의 기본 개념과 실무 적용 명령어를 
