...
---
> **[핵심 요약]**
> 배열과 포인터를 활용해 다항식을 입력받고 학번 조건에 맞는 곱셈 결과를 계산하는 C언어 프로그램입니다.

---

## 1. 개요 및 배경

다항식의 곱셉 - 4개의 학번(차,계,차,계)을 입력받는  다항식의 곱은 컴퓨터 프로그래밍 및 시스템 운용 시 자주 접하게 되는 핵심 기술 요소입니다. 

---

## 2. 핵심 설명 및 코드

> 다항식의 곱셉 - 4개의 학번(차,계,차,계)을 입력받는  다항식의 곱의 기본 개념과 실무 적용 명령어를 
