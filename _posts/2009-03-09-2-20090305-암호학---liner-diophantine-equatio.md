...
---
> **[핵심 요약]**
> 선형 디오판토스 방정식(Linear Diophantine Equation)의 정수해를 구하는 확장 유클리드 알고리즘 구현입니다.

---

## 1. 개요 및 배경

[2009/03/05] 암호학 - Liner Diophantine Equation(선형 디오팔투스 방정식)은 컴퓨터 프로그래밍 및 시스템 운용 시 자주 접하게 되는 핵심 기술 요소입니다. 

---

## 2. 핵심 설명 및 코드

> [2009/03/05] 암호학 - Liner Diophantine Equation(선형 디오팔투스 방정식)의 기본 개념과 실무 적용 명령어를 
