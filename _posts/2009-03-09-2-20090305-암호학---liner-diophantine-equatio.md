...
categories: ["프로그래밍", "기타"]
tags: ["diophantine", "디오팔투스", "암호학"]
---

> 💡 **TL;DR (핵심 요약)**  
> [2009/03/05] 암호학 - Liner Diophantine Equation(선형 디오팔투스 방정식)에 대한 상세 설명 및 핵심 가이드입니다.

---

## 1. 개요 및 배경

[2009/03/05] 암호학 - Liner Diophantine Equation(선형 디오팔투스 방정식) 가이드 및 실무 적용 설명입니다.
