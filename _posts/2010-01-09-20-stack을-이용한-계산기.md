...
---
> **[핵심 요약]**
> 스택(Stack) 자료구조를 활용하여 수식을 후위 표기법(Postfix)으로 변환하고 계산하는 사칙연산 프로그램입니다.

---

## 1. 개요 및 배경

Stack을 이용한 계산기은 컴퓨터 프로그래밍 및 시스템 운용 시 자주 접하게 되는 핵심 기술 요소입니다. 

---

## 2. 핵심 설명 및 코드

> Stack을 이용한 계산기의 기본 개념과 실무 적용 명령어를 
