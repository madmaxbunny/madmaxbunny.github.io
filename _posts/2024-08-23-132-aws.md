...
> **[핵심 요약]**
> AWS EC2 인스턴스 접속부터 Nginx 설치, SSH 키젠 무암호 접속 및 Java 8, Tomcat 9 WAS 환경 구축 절차이에요.

---

## 1. 개요 및 배경

AWS EC2 인스턴스를 최초 생성한 후 개발 및 웹 서비스를 위해 Nginx, Tomcat 9, Java 8 환경을 구축했던 과정을 정리해봤어요.
